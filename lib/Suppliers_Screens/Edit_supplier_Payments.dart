...
class Edit_supplier_Payments extends StatefulWidget {
  static String screenID = 'Edit_Payments';

  @override
  _Edit_supplier_PaymentsState createState() => _Edit_supplier_PaymentsState();
}

class _Edit_supplier_PaymentsState extends State<Edit_supplier_Payments> {
            ...
            return ListView.separated(
              ...
              itemBuilder: (ctx, index) {
                ...
                return ListTile(
                  ...
                  onTap: () {
                    showAlert(ctx, payments_list![index], supplier);
                  },
                  onLongPress: () {
                    showDialog(
                        context: context,
                        builder: (ctx) => AlertDialog(
                              ...
                              content: Row(
                                ...
                                children: [
                                  ...
                                  ElevatedButton(
                                    onPressed: () {
                                      store.delete_supplier_payment(
                                          supplier, payments_list![index]);
                                      Navigator.pop(ctx);
  ...
  Future showAlert(crx, Payment payment, Supplier supplier) async {
    var value_deleted_from_receipt = int.tryParse(payment.reciever);
    showDialog(
        context: crx,
        builder: (crx) => StatefulBuilder(builder: (ctc, setDialogstate) {
              date_controller = payment.date;
              reciever_controller.text = payment.reciever;
  ...
  editPayment(Supplier supplier, Payment payment) {
    try {
